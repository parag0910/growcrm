                                ...
                                <div class="col-lg-6">
                                    <div class="project-wrap">
                                        <div class="project-body">
                                            <div>
                                                <a href="<?php echo e(route('project.show',\Crypt::encrypt($project->id))); ?>"><h4><?php echo e($project->title); ?></h4></a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\products-temp\growcrm\resources\views/project/index.blade.php ENDPATH**/ ?>