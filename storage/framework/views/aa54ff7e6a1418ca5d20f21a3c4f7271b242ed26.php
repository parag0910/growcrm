            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                <ul class="navbar-nav">
                    ...
                    <?php if(\Auth::user()->type=='company'): ?>
                        <li class="nav-item ">
                            <a class="nav-link <?php echo e((Request::segment(1) == 'employee' || Request::segment(1) == 'client')?'active':''); ?>" href="#staff" data-toggle="collapse" role="button" aria-expanded="<?php echo e((Request::segment(1) == 'user' )?'true':'false'); ?>" aria-controls="navbar-dashboards1">
                                <i class="ni ni-single-02 text-danger"></i>
                                <span class="nav-link-text "><?php echo e(__('Staff')); ?></span>
                            </a>
                            <div class="collapse <?php echo e((Request::segment(1) == 'employee' || Request::segment(1) == 'client')?'show':''); ?>" id="staff">
                                <ul class="nav nav-sm flex-column">
                                    <?php if(\Auth::user()->type == 'company'): ?>
                                        <li class="nav-item <?php echo e((Request::segment(1) == 'employee')?'active open':''); ?>">
                                            <a href="<?php echo e(route('employee.index')); ?>" class="nav-link"><?php echo e(__('Employee')); ?></a>
                                        </li>
                                        <li class="nav-item <?php echo e((Request::segment(1) == 'client')?'active open':''); ?>">
                                            <a href="<?php echo e(route('client.index')); ?>" class="nav-link"><?php echo e(__('Client')); ?></a>
                                        </li>
                                    <?php endif; ?>
                                </ul>
                            </div>
                                ...
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <?php if(\Auth::user()->type=='company' || \Auth::user()->type=='client'): ?>
                                        <li class="nav-item <?php echo e((Request::segment(1) == 'estimate')?'active open':''); ?>">
                                            <a href="<?php echo e(route('estimate.index')); ?>" class="nav-link"><?php echo e(__('Estimation')); ?></a>
                                        </li>
                                    <?php endif; ?>
                                </ul>
                            </div>
                    ...
                    <?php if(\Auth::user()->type=='company' || \Auth::user()->type=='client'): ?>
                        <li class="nav-item ">
                            <a class="nav-link <?php echo e((Request::segment(1) == 'invoice' || Request::segment(1) == 'payment' || Request::segment(1) == 'creditNote' || Request::segment(1) == 'expense')?'active':''); ?>" href="#income" data-toggle="collapse" role="button" aria-expanded="<?php echo e((Request::segment(1) == 'invoice' || Request::segment(1) == 'payment' || Request::segment(1) == 'creditNote' || Request::segment(1) == 'expense')?'true':'false'); ?>" aria-controls="income">
                                ...
                                <span class="nav-link-text "><?php echo e(__('Sale')); ?></span>
                            </a>
                            <div class="collapse <?php echo e((Request::segment(1) == 'invoice' || Request::segment(1) == 'payment' || Request::segment(1) == 'creditNote' || Request::segment(1) == 'expense')?'show':''); ?>" id="income">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item <?php echo e((Request::segment(1) == 'invoice')?'active open':''); ?>">
                                        <a href="<?php echo e(route('invoice.index')); ?>" class="nav-link"><?php echo e(__('Invoices')); ?></a>
                                    </li>
 ...
 Request::segment(1) == 'estimate-report' || Request::segment(1) == 'invoice-report' || Request::segment(1) == 'lead-report' || Request::segment(1) == 'client-report' || Request::segment(1) == 'attendance-report')?'show':''); ?>" id="report">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item <?php echo e((Request::segment(1) == 'invoice-report')?'active open':''); ?>">
                                        <a href="<?php echo e(route('report.invoice')); ?>" class="nav-link"><?php echo e(__('Invoice')); ?></a>
                                    </li>
                    ...
                    ?'active':''); ?>" href="#constant" data-toggle="collapse" role="button"
                               aria-expanded="<?php echo e((Request::segment(1) == 'department' || Request::segment(1) == 'designation' || Request::segment(1) == 'salaryType'  || Request::segment(1) == 'leaveType' || Request::segment(1) == 'pipeline' || Request::segment(1) == 'leadStage' || Request::segment(1) == 'projectStage' || Request::segment(1) == 'dealStage' || Request::segment(1) == 'source' || Request::segment(1) == 'label'  || Request::segment(1) == 'taxRate' || Request::segment(1) == 'unit' ||
                           Request::segment(1) == 'category' || Request::segment(1) == 'paymentMethod' || Request::segment(1) == 'contractType'  || Request::segment(1) == 'termination-type' || Request::segment(1) == 'award-type'  || Request::segment(1) == 'training-type')
                           ?'true':'false'); ?>"
                               aria-controls="navbar-dashboards1"> <i class="ni ni-atom"></i>
                        ...
                        ?'show':''); ?>" id="constant">
                                ...
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item <?php echo e((Request::segment(1) == 'paymentMethod')?'active open':''); ?>">
                                        <a href="<?php echo e(route('paymentMethod.index')); ?>" class="nav-link"><?php echo e(__('Payment Method')); ?></a>
                                    </li>
...
<?php /**PATH C:\wamp64\www\products-temp\growcrm\resources\views/partials/admin/menu.blade.php ENDPATH**/ ?>